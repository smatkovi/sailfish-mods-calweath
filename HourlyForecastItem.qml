...
Column {
	...
	Label {
    visible: model.windSpeed !== undefined || model.maximumWindSpeed !== undefined
    text: (model.windSpeed !== undefined
              ? model.windSpeed
              : (model.maximumWindSpeed !== undefined ? model.maximumWindSpeed +"m/s" : "")) + (text !== "" ? " m/s" : "")
    anchors.horizontalCenter: parent.horizontalCenter
    font.pixelSize: Theme.fontSizeTiny
    color: highlighted ? Theme.secondaryHighlightColor : Theme.secondaryColor
...
Label {
    visible: model.windDirection !== undefined
    text: Math.round(model.windDirection) + "°"
    anchors.horizontalCenter: parent.horizontalCenter
    font.pixelSize: Theme.fontSizeTiny
    color: highlighted ? Theme.secondaryHighlightColor : Theme.secondaryColor
}
