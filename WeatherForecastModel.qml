    ...
    readonly property WeatherRequest model: WeatherRequest {
        ...
        onRequestFinished: {
            ...
            if (result.length === 0 || forecast.length === "") {
			    ...
			    weather.windSpeed = weather.windSpeed !== undefined
                        ? weather.windSpeed
                        : (data.windSpeed !== undefined
                            ? data.windSpeed
                            : (data.ws !== undefined ? data.ws : undefined))
			weather.windDirection = weather.windDirection !== undefined
                        ? weather.windDirection
                        : (data.windDirection !== undefined
                            ? data.windDirection
                            : (data.windDir !== undefined ? data.windDir : undefined))
                    } else {
